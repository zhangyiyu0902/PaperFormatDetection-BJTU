...
namespace PaperFormatDetection.Tools
{
    class Util
    {
        ...
        public static string environmentDir = @"C:\Users\DELL\Desktop\PaperFormatDetection\PaperFormatDetection-master\PaperFormatDetection\PaperFormatDetection\bin\Debug";
        ...
        {
            string[] Undergraduate = new string[] { "摘要", "Abstract", "目录", "引言", "1绪论", "结论", "参考文献", "附录", "致谢" };
